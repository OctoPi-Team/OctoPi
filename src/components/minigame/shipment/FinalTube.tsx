...
export function FinalTube({ victoryTileSequence, getRealPositionFromGridPosition, vectorsForInputTube }: FinalTubeProps) {
	...
	for (let i = 0; i < list.length; i++) {
		switch (list[i].tileType) {
			case TileType.AngleRight: {
				startVector = getRealCornerPositionFromGridPosition(list[i].gridPosition, new Vector3(0, 0, -GameSpec.tileSize / 2));
				...
				endVector = getRealCornerPositionFromGridPosition(list[i].gridPosition, new Vector3(-GameSpec.tileSize / 2, 0, 0));
			...
			case TileType.StraightNormal: {
				startVector = getRealCornerPositionFromGridPosition(list[i].gridPosition, new Vector3(-GameSpec.tileSize / 2, 0, 0));
			...
			case TileType.StraightInverted: {
				...
				cubicbenziercontrol1 = getRealCornerPositionFromGridPosition(list[i].gridPosition, new Vector3(0, 0, 0));
				cubicbenziercontrol2 = getRealCornerPositionFromGridPosition(list[i].gridPosition, new Vector3(0, 0, 0));
				endVector = getRealCornerPositionFromGridPosition(list[i].gridPosition, new Vector3(0, 0, GameSpec.tileSize / 2));
